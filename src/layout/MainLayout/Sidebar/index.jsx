...
const Sidebar = () => {
    ...
    return (
      <Box component="nav" sx={{ flexShrink: { md: 0 }, width: { xs: 'auto', md: drawerWidth } }} aria-label="mailbox folders" elevation={2}>
          ...
          <Drawer
            ...
            sx={{
              '& .MuiDrawer-paper': {
                ...
                color: 'text.primary',
                borderRight: '1px solid rgba(0, 0, 0, 0.12)', // Subtle border
                boxShadow: downMD ? 'none' : '2px 0px 5px rgba(0, 0, 0, 0.1)' // Light shadow for elevation
              }
            }}
